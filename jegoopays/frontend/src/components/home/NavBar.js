...
function NavBar (){
  ...
  return (<div >
      <Navbar bg="success"  className="fixed-top" variant="dark"  expand="lg">
        <Navbar.Brand  href="/">
          <h3 style={{}}>JE GO O PAYS</h3>
          <img  className="rounded-circle bg-danger" src='../../logo.jpeg' style={{width:"52px", marginLeft:"50px"}}/>
        </Navbar.Brand>
